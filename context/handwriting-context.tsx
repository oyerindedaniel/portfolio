...
export const HandwritingProvider = ({ children }: React.PropsWithChildren) => {
  const config = useMemo<HandwritingConfig>(
    () => ({
      baseLineHeight: 53,
      lineSpacing: 15,
      baseOffset: 23,
